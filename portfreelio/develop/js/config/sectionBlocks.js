    ...
    content: `<nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <section id="hero" class="d-flex flex-column align-items-center justify-content-center pt-4">
        ...
        <div class="hero-image p-4 bg-white shadow-sm rounded">
          <img src="https://res.cloudinary.com/dpnea22ek/image/upload/c_scale,q_100,w_1400/v1627100771/portfreelio.jpg" alt="Portfreelio">
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="d-flex justify-content-center flex-column p-4">
              ...
              <p class="subtitle">with Portfreelio page builder</p>
              <div class="buttons">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-2 col-md-3 text-center">
          <p class="text-muted mb-2">Google</p><img src="https://cdn.statically.io/gh/ronaldaug/portfreelio/refactor/portfreelio/develop/svg/brands/google.svg" alt="Google">
        </div>
        <div class="col-lg-2 col-md-3 text-center">
          <p class="text-muted mb-2">Nike</p><img src="https://cdn.statically.io/gh/ronaldaug/portfreelio/refactor/portfreelio/develop/svg/brands/google.svg" alt="Nike">
        </div>
        <div class="col-lg-2 col-md-3 text-center">
          <p class="text-muted mb-2">Apple</p><img src="https://cdn.statically.io/gh/ronaldaug/portfreelio/refactor/portfreelio/develop/svg/brands/apple.svg" alt="Apple">
        </div>
        <div class="col-lg-2 col-md-3 text-center">
          <p class="text-muted mb-2">IBM</p><img src="https://cdn.statically.io/gh/ronaldaug/portfreelio/refactor/portfreelio/develop/svg/brands/ibm.svg" alt="IBM">
        </div>
        <div class="col-lg-2 col-md-3 text-center">
          <p class="text-muted mb-2">Uber</p><img src="https://cdn.statically.io/gh/ronaldaug/portfreelio/refactor/portfreelio/develop/svg/brands/uber.svg" alt="Uber">
        </div>
        <div class="col-lg-2 col-md-3 text-center">
          <p class="text-muted mb-2">Window</p><img src="https://cdn.statically.io/gh/ronaldaug/portfreelio/refactor/portfreelio/develop/svg/brands/window.svg" alt="Window">
        </div>
      </div>
    </div>
        ...
        <div class="row mt-5">
          <div class="col-12">
            <p class="text-center text-muted">
              <small>&copy; 2019-2021 | Portfreelio | All Rights Reserved.</small>
            </p>
          </div>
        </div>
      </div>
